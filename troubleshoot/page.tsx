    ...
    <div className="container mx-auto py-8">
      ...
      <div className="grid gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>
                  NEXTAUTH_SECRET is set to a secure random string (at least 32
                  characters)
                </li>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                If API features aren't working:
              </p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4">
              Run the database test script to verify your connection and check
            ...
            <Alert variant="warning">
              ...
              <AlertDescription>
                Make sure your DATABASE_URL environment variable is correctly
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Start fresh if you're experiencing persistent issues
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="mb-4">
              If you're experiencing persistent issues, you can try resetting
              the application:
            </p>
            <ol className="list-decimal list-inside space-y-2 mb-4">
              ...
              <li>
                Run pnpm install to ensure all dependencies are correctly
                installed
              </li>
